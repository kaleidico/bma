...
$regex_is_user_agent_bot = 'RSS\b|Rackspace Monitoring|\babonti|\bagent\b|\bask\.com|\bbot\b|\bbrandverity|\bcoccoc\b|\bfeed|\bfetcher|\bflipboard|\bgenieo|\bgoogle|\bhealth|\binstagram\b|\bitunes\b|\bmonitor|\bnutch\b|\bpingback\b|\bprtg\b|\brss\b|\bsnapchat|\bstatus|\bthunderstone|\bwazzup|\byeti\b|\wbot|^8legs|^Breaker/|^FeedHQ/|^G-i-g-a-b-o-t|^Liferea|^The Knowledge|^YahooMailProxy|^expo9|^newsbeuter|^omgili|^spray-can|^ssowl|^tzogeo|^tzogeoagent|^wpe-content-performance|addthis|alexa|baidu|bingpreview|bot|buzz\b|check\b|crawler|dataaccessd|dataprovider|duckduckgo|facebook|feed|indexer|jakarta|metrics\b|monitor\b|news|panscient|ping\b|pinterest|pubsub|re[ea]der|reader\b|rv:x\.x\.x|scan(?:ner)?\b|scoutjet|scrap(?:[ey]|ing)|seeker\b|simplepie|siteimprove\b|slurp\b|spi_?der|teoma|yandex';
